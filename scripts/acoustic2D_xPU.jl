...
acoustic2D(2100.0, 1200.0, 1500, vel, possrcs; halo=5, rcoef=0.01, do_vis=true, gif_name="acoustic2D_halo5_ps")
acoustic2D(2100.0, 1200.0, 1500, vel, possrcs; halo=10, rcoef=0.001, do_vis=true, gif_name="acoustic2D_halo10_ps")
acoustic2D(2100.0, 1200.0, 1500, vel, possrcs; halo=20, rcoef=0.0001, do_vis=true, gif_name="acoustic2D_halo20_ps")
acoustic2D(2100.0, 1200.0, 1500, vel, possrcs; halo=40, rcoef=0.00001, do_vis=true, gif_name="acoustic2D_halo40_ps")
...
acoustic2D(2100.0, 2100.0, 1000, vel, possrcs; halo=5, rcoef=0.01, do_vis=true, gif_name="acoustic2D_center_halo5_ps", freetop=false, threshold=0.001)
acoustic2D(2100.0, 2100.0, 1000, vel, possrcs; halo=10, rcoef=0.001, do_vis=true, gif_name="acoustic2D_center_halo10_ps", freetop=false, threshold=0.001)
acoustic2D(2100.0, 2100.0, 1000, vel, possrcs; halo=20, rcoef=0.0001, do_vis=true, gif_name="acoustic2D_center_halo20_ps", freetop=false, threshold=0.001)
acoustic2D(2100.0, 2100.0, 1000, vel, possrcs; halo=40, rcoef=0.00001, do_vis=true, gif_name="acoustic2D_center_halo40_ps", freetop=false, threshold=0.001)

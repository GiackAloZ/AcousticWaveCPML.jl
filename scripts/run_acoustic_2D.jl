...
function run_center_freetop()
    ...
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=0, do_vis=true, nvis=20, gif_name="acoustic2D_center_freetop_halo0", freetop=true, threshold=0.001, plims=[-2e-8,2e-8])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=5, rcoef=0.01, do_vis=true, nvis=20, gif_name="acoustic2D_center_freetop_halo5", freetop=true, threshold=0.001, plims=[-2e-8,2e-8])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=10, rcoef=0.001, do_vis=true, nvis=20, gif_name="acoustic2D_center_freetop_halo10", freetop=true, threshold=0.001, plims=[-2e-8,2e-8])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=20, rcoef=0.0001, do_vis=true, nvis=20, gif_name="acoustic2D_center_freetop_halo20", freetop=true, threshold=0.001, plims=[-2e-8,2e-8])
end
...
function run_gradient()
    ...
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=0, do_vis=true, nvis=20, gif_name="acoustic2D_gradient_freetop_halo0", freetop=true, threshold=0.01, plims=[-3e-9,3e-9])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=5, rcoef=0.01, do_vis=true, nvis=20, gif_name="acoustic2D_gradient_freetop_halo5", freetop=true, threshold=0.01, plims=[-3e-9,3e-9])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=10, rcoef=0.001, do_vis=true, nvis=20, gif_name="acoustic2D_gradient_freetop_halo10", freetop=true, threshold=0.01, plims=[-3e-9,3e-9])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=20, rcoef=0.0001, do_vis=true, nvis=20, gif_name="acoustic2D_gradient_freetop_halo20", freetop=true, threshold=0.01, plims=[-3e-9,3e-9])
end
...
function run_complex()
    ...
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=0, do_vis=true, nvis=50, gif_name="acoustic2D_complex_freetop_halo0", freetop=true, threshold=0.05, plims=[-2e-9,2e-9])
    solve2D(lx, ly, lt, vel, srcs, recs;
            halo=20, rcoef=0.0001, do_vis=true, nvis=50, gif_name="acoustic2D_complex_freetop_halo20", freetop=true, threshold=0.05, plims=[-2e-9,2e-9])
end
